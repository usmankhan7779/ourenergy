...
export class EnrollmentComponent implements OnInit {
  ...
  changeAutoBillPay() {
    ...
    this.fourFormGroup.value['deposit_acct_type'] = ''
    this.fourFormGroup.value['deposit_account_no'] = ''
    this.fourFormGroup.value['deposit_aba_nbr'] = ''
    this.fourFormGroup.value['confirm_routing'] = ''
    this.fourFormGroup.value['confirm_account'] = ''
  ...
  changeAutoBillPayACH(event) {
    this.fourFormGroup.value['deposit_card_type'] = ''
    this.fourFormGroup.value['deposit_cc_no'] = ''
    this.fourFormGroup.value['deposit_security_code'] = ''
    this.fourFormGroup.value['deposit_expiry_MM'] = ''
    this.fourFormGroup.value['deposit_expiry_YYYY'] = ''
    this.Check = 'ACH'
    // alert(event)
